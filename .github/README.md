...
| ------------ | -------------------------------------------------------------------------------------------------------------------------------------------- |
| amd64        | [node-template_0.6.3_amd64.AppImage](https://github.com/spotdemo4/node-template/releases/download/v0.6.3/node-template_0.6.3_amd64.AppImage) |
| arm64        | [node-template_0.6.3_arm64.AppImage](https://github.com/spotdemo4/node-template/releases/download/v0.6.3/node-template_0.6.3_arm64.AppImage) |

### docker

```elm
docker run ghcr.io/spotdemo4/node-template:0.6.3
```
...
```yaml
- name: node template
  uses: spotdemo4/node-template@v0.6.3
```
